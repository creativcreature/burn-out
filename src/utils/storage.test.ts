...
describe('storage', () => {
  ...
  describe('getData', () => {
    it('returns stored data when available', async () => {
      const storedData: BurnOutData = {
        ...
        goals: [{ id: 'goal-1', title: 'Test Goal', timeframe: '1y', isActive: false, rank: 1, createdAt: '', updatedAt: '', archived: false, order: 0 }],
        projects: [],
        tasks: [],
        taskCategories: [],
        habits: [],
        ...
        chatHistory: [],
        conversations: [],
        settings: { notifications: true, dailyReminder: '09:00', haptics: true, soundEnabled: true, aiProvider: 'gemini' },
  ...
  describe('saveData', () => {
    it('saves data to storage', async () => {
      const data: BurnOutData = {
        ...
        chatHistory: [],
        conversations: [],
        settings: { notifications: false, dailyReminder: null, haptics: true, soundEnabled: true, aiProvider: 'gemini' },
  ...
  describe('updateData', () => {
    ...
    it('returns updated data', async () => {
      ...
      const result = await updateData(data => ({
        ...data,
        goals: [{ id: 'new-goal', title: 'New', timeframe: '1y' as const, isActive: false, rank: 1, createdAt: '', updatedAt: '', archived: false, order: 0 }]
      }))
