      ...
      <div style={contentStyle}>
        ...
        <div style={controlsStyle}>
          ...
          <button
            ...
            title="Mark complete"
          >
            <svg style={iconStyle(false)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div style={dueSectionStyle}>
          <div style={dueHeaderStyle}>
            <div>
              <div style={dueLabelStyle}>energy</div>
              <div style={dueValueStyle}>{task.feedLevel}</div>
            </div>
            <div style={metaStyle}>
        ...
        {/* Tags showing task info */}
        <div style={tagsRowStyle}>
          <Tag variant="energy">{task.feedLevel} energy</Tag>
          {task.timeOfDay && task.timeOfDay !== 'anytime' && (
            <Tag variant="focus">{task.timeOfDay}</Tag>
          )}
        </div>
      </div>
    </div>
